...
[IDEA-25](https://github.com/starkience/strk20-hackathon/blob/main/IDEAS.md) asked for a pre-sign privacy simulator. We do not invent an anonymity-set size (the docs do not publish one). We score the leaks the protocol already named.
